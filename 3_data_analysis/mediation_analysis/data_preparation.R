...
load(
  "data_analysis/4_exposome_chemical_data_analysis/data_preparation/expression_data"
)
load("data_analysis/4_exposome_chemical_data_analysis/data_preparation/sample_info")
load("data_analysis/4_exposome_chemical_data_analysis/data_preparation/variable_info")
...
###child exposome air
load(
  "data_analysis/5_exposome_air_data_analysis/data_preparation/expression_data"
)
load("data_analysis/5_exposome_air_data_analysis/data_preparation/sample_info")
load("data_analysis/5_exposome_air_data_analysis/data_preparation/variable_info")
...
load(
  "data_analysis/6_exposome_outdoor_data_analysis/data_preparation/expression_data"
)
load("data_analysis/6_exposome_outdoor_data_analysis/data_preparation/sample_info")
load("data_analysis/6_exposome_outdoor_data_analysis/data_preparation/variable_info")
...
###transcriptome
load(
  "data_analysis/1_transcriptome_data_analysis/data_preparation/expression_data"
)
load("data_analysis/1_transcriptome_data_analysis/data_preparation/sample_info")
load("data_analysis/1_transcriptome_data_analysis/data_preparation/variable_info")
...
###proteome
load(
  "data_analysis/8_proteome_data_analysis/data_preparation/expression_data"
)
load("data_analysis/8_proteome_data_analysis/data_preparation/sample_info")
load("data_analysis/8_proteome_data_analysis/data_preparation/variable_info")
...
###serum_metabolome
load(
  "data_analysis/2_serum_metabolome_data_analysis/data_preparation/expression_data"
)
load("data_analysis/2_serum_metabolome_data_analysis/data_preparation/sample_info")
load("data_analysis/2_serum_metabolome_data_analysis/data_preparation/variable_info")
...
###urine_metabolome
load(
  "data_analysis/3_urine_metabolome_data_analysis/data_preparation/expression_data"
)
load("data_analysis/3_urine_metabolome_data_analysis/data_preparation/sample_info")
load("data_analysis/3_urine_metabolome_data_analysis/data_preparation/variable_info")
