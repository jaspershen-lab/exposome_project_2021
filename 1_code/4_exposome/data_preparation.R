...
codebook$labels[codebook$labels == "DMDTP" &
                  codebook$period == "Postnatal" &
                  codebook$labelsshort == "DMTP"] = "DMTP"
...
#######exposome chemical
setwd(r4projects::get_project_wd())
setwd("3_data_analysis/4_exposome_chemical_data_analysis/data_preparation/")
...
#######exposome Indoor air
setwd(r4projects::get_project_wd())
setwd("3_data_analysis/5_exposome_air_data_analysis/data_preparation/")
...
#######Outdoor exposures
setwd(r4projects::get_project_wd())
setwd("3_data_analysis/6_exposome_outdoor_data_analysis/data_preparation/")
...
codebook1$labels[codebook1$period == "Postnatal" &
                   codebook1$description == "Relative humidityone day before at home"] = "Hum.(day)"
...
#######Lifestyles
setwd(r4projects::get_project_wd())
setwd("3_data_analysis/7_lifecycle_outdoor_data_analysis/data_preparation/")
