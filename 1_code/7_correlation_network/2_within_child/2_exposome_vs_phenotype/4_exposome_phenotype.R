...
dir.create("3_data_analysis/correlation_network/within_child/exposome_vs_phenotype")
setwd("3_data_analysis/correlation_network/within_child/exposome_vs_phenotype")
