...
setwd(r4projects::get_project_wd())
dir.create("3_data_analysis/correlation_network/within_child/exposome_air_vs_phenotype")
setwd("3_data_analysis/correlation_network/within_child/exposome_air_vs_phenotype")
