...
exposome_chemical_variable_info = 
  exposome_chemical_variable_info[remain_idx,]

exposome_chemical_expression_data =
  exposome_chemical_expression_data[remain_idx, ]

setwd(r4projects::get_project_wd())
dir.create("3_data_analysis/correlation_network/within_child/exposome_chemical_vs_phenotype")
setwd("3_data_analysis/correlation_network/within_child/exposome_chemical_vs_phenotype")

#####glm
exposome_chemical_phenotype_glm = 
exposome_chemical_sample_info[,c("Behavior", "Body.mass.index.z.score", "Intelligence.quotient")] %>% 
...
save(exposome_chemical_phenotype_glm, file = "exposome_chemical_phenotype_glm")
