...
setwd(r4projects::get_project_wd())
dir.create("3_data_analysis/correlation_network/within_child/exposome_outdoor_vs_serum_metabolome")
setwd("3_data_analysis/correlation_network/within_child/exposome_outdoor_vs_serum_metabolome")
...
###network for all the exposome_outdoor and serum_metabolome
edge_data <-  
  cor_value %>% 
...
ggsave(
  plot1,
  filename = "exposome_outdoor_serum_metabolome_correlation_network.pdf",
  width = 8.5,
  height = 7,
  bg = "transparent"
)
