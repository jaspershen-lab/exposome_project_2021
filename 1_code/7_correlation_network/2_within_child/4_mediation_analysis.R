...
load("3_data_analysis/correlation_network/within_child/internal_ome_phenotype/internal_ome_phenotype_glm")
...
setwd("3_data_analysis/correlation_network/within_child/mediation_analysis")
