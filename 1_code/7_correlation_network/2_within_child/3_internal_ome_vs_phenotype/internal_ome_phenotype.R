...
dir.create("3_data_analysis/correlation_network/within_child/internal_ome_phenotype")
setwd("3_data_analysis/correlation_network/within_child/internal_ome_phenotype")
