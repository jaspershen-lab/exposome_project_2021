...
setwd(r4projects::get_project_wd())
dir.create("3_data_analysis/correlation_network/within_child/serum_metabolome_vs_phenotype")
setwd("3_data_analysis/correlation_network/within_child/serum_metabolome_vs_phenotype")
