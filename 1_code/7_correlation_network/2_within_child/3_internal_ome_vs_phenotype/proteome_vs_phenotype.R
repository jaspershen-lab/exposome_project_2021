...
setwd(r4projects::get_project_wd())
dir.create("3_data_analysis/correlation_network/within_child/proteome_vs_phenotype")
setwd("3_data_analysis/correlation_network/within_child/proteome_vs_phenotype")
...
save(proteome_phenotype_glm, file = "proteome_phenotype_glm")
