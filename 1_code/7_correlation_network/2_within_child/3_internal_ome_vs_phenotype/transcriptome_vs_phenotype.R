...
setwd(r4projects::get_project_wd())
dir.create("3_data_analysis/correlation_network/within_child/transcriptome_vs_phenotype")
setwd("3_data_analysis/correlation_network/within_child/transcriptome_vs_phenotype")
...
save(transcriptome_phenotype_glm, file = "transcriptome_phenotype_glm")
